  ...
  render() {
    return (
      <form
        ...
        style={this.unsubCss}
        onSubmit={this.unsubscribe(this.props.unsubscribeCall)}
      >
        <div className='form-group row'>
          ...
          <label>
            <Input
              ...
              type='checkbox'
              value='green'
              label='I  no longer want to receive messages'
              className='filled-in'
        ...
        {!this.props.toastMsg ? (
          ...
          <Toast className='red' toast={this.props.toastMsg}>
            {this.props.toastMsg}
          </Toast>
        )}
      </form>
