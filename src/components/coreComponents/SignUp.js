  ...
  return (
    <div className='container signup'>
      <ScrollAnimation animateIn='fadeInDown'>
            ...
            <div className='row'>
              <div className='col-md-4 login-sec'>
                ...
                <form
                  ...
                  onSubmit={Subscribe(subscribeCall)}
                >
                  ...
                  {!toastMsg ? (
                    ...
                    <Toast toast={toastMsg}>{toastMsg}</Toast>
                  )}
                </form>
              </div>
        ...
        <ScrollAnimation
          className='animated infinite bounce delay-4s'
          animateIn='bounce'
        >
          <span style={{ fontSize: '44px', color: 'darkgrey', width: '44px' }}>
            ↓
          </span>
        </ScrollAnimation>
      </ScrollAnimation>
